...
attachment_dir = 'C:/Users/RISHABH KUMAR/Desktop/'
...
def login_view(request):
    ...
    if request.method == 'POST':
        ...
        imap_url = 'imap.gmail.com'
        passwrd = 'bagh gvle wgvc iulu'
        addr = 'pihupriyap14@gmail.com'
        conn = imaplib.IMAP4_SSL(imap_url)
        try:
            conn.login('pihupriyap14@gmail.com','bagh gvle wgvc iulu')
            s.login('pihupriyap14@gmail.com','bagh gvle wgvc iulu')
    ...
    for part in msg.walk():
        ...
        if bool(filename):
            ...
            with open(filepath, "wb") as f:
                ...
                i = i + str(1)
                path = 'C:/Users/RISHABH KUMAR/Desktop/'
